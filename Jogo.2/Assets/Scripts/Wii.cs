...
{	
	...
	#if UNITY_STANDALONE_OSX && UNITY_2018_1_OR_NEWER && !UNITY_EDITOR
	private const string pluginName = "x86_64/WiiBuddy64";
	#else
	private const string pluginName = "WiiBuddy64";
	#endif
	#else
	#if UNITY_STANDALONE_OSX && UNITY_2017_1_OR_NEWER && !UNITY_EDITOR && !UNITY_STANDALONE_OSX
	private const string pluginName = "x86/WiiBuddy32";
	#else
